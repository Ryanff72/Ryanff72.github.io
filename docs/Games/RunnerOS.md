...
During this project, my primary role was gameplay programmer. I programmed the functionality of the character's movement, the gravity window, the checkpoints, the spikes, and helped program scripts related to the UI of the game's desktop. I also implemented a majority of the art provided by artists, especially within the game window.
