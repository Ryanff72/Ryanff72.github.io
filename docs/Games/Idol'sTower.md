...
## Screenshots
![idols tower 1](images/idolsTower1.png){: width="450" } <br>
![idols tower 2](images/idolsTower2.png){: width="450" } <br>
![idols tower 3](images/idolsTower3.png){: width="450" } <br>
...
For this game, I acted as the project lead, artist, programmer. As a programmer, I worked on the character controls, the boss fight, enemies, level mechanics, and more!
