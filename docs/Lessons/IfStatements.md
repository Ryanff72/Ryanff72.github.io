...
![image](https://user-images.githubusercontent.com/64915846/189804942-772ee274-a678-4ac8-98c9-1c5614a29618.png){: width="450"}
## Challenge 2
...
**Else if** and **else** statements are useful if you need to account for alternative values a variable can have. **Else if** statements go below an **if** statement, and will only be ran if the **if** statement above them is false. 
